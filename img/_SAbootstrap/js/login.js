...
function login(){
  ...
  if (localStorage.length > 0){
    ...
    if (email !== "brasilvidaroleplay3@gmail.com" || password !== "1243"){
    ...
    } else if (email === "brasilvidaroleplay3@gmail.com" && password === "1243") {
  ...
  else  alert("Ainda não existem lojas cadastradas!\nFavor entrar em contato com o Administrador...");
